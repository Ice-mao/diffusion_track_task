...
v2_sample_student_fns = lambda: StudentObsWrapper(make(env_name='AUVTracking_v2_sample',
                                                  record=False,
                                                  show_viewport=True,
                                                  num_targets=1,
                                                  is_training=True,
...
v2_sample_student_fns_norender = lambda: StudentObsWrapper(make(env_name='AUVTracking_v2_sample',
                                                  record=False,
                                                  show_viewport=False,
                                                  num_targets=1,
                                                  is_training=True,
...
v2_sample_student_fns_render = lambda: StudentObsWrapper(make(env_name='AUVTracking_v2_sample',
                                                  record=False,
                                                  show_viewport=True,
                                                  num_targets=1,
                                                  is_training=True,
...
gym.register(
    id="v2-sample-student",
    entry_point=v2_sample_student_fns,
    disable_env_checker=True,
)
gym.register(
    id="v2-sample-student-norender",
    entry_point=v2_sample_student_fns_norender,
    disable_env_checker=True,
)
gym.register(
    id="v2-sample-student-render",
    entry_point=v2_sample_student_fns_render,
    disable_env_checker=True,
)
gym.register(
    id="v2-sample-render",
